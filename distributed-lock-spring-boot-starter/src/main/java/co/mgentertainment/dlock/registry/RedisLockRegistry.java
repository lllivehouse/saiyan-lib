...
package co.mgentertainment.dlock.registry;
...
public final class RedisLockRegistry implements ExpirableLockRegistry, DisposableBean {
    ...
    private final String clientId = UUID.fastUUID().toString(true);
     ...
     */
    public RedisLockRegistry(LettuceConnectionFactory connectionFactory, String registryKey) {
     ...
     */
    public RedisLockRegistry(LettuceConnectionFactory connectionFactory, String registryKey, long expireAfter) {
    ...
    private abstract class RedisLock implements Lock {
        ...
        protected final RedisScript<Boolean>
    ...
    private final class RedisPubSubLock extends RedisLock {
        ...
        private final RedisScript<Boolean>
    ...
    private static class RedisUnLockNotifyMessageListener implements MessageListener {
