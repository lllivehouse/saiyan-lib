...
package co.mgentertainment.dlock.repository;
...
public class DefaultLockRepository
     ...
     */
    public static final String DEFAULT_TABLE_PREFIX = "distributed_";
    ...
    private String countAllQuery = "SELECT COUNT(region) FROM %slock";
