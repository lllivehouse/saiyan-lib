...
import co.mgentertainment.common.apiclient.core.ClientProfile;
    ...
    public static AbstractHttpClient buildClient(ClientProfile profile) {
        try {
            ...
            if (!AbstractHttpClient.class.isAssignableFrom(httpClientClass)) {
                throw new IllegalStateException(String.format("%s is not assignable from co.mgentertainment.common.apiclient.core.http.AbstractHttpClient", customClientClassName));
