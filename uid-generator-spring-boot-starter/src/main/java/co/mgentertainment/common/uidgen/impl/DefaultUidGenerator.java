 ...
 */
package co.mgentertainment.common.uidgen.impl;

import co.mgentertainment.common.uidgen.BitsAllocator;
import co.mgentertainment.common.uidgen.UidGenerator;
import co.mgentertainment.common.uidgen.exception.UidGenerateException;
import co.mgentertainment.common.uidgen.utils.NetUtils;
import co.mgentertainment.common.uidgen.worker.WorkNodeService;
import co.mgentertainment.common.uidgen.utils.DateUtil;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        workerId = workNodeService.assignWorkerId();
    ...
    public void destroy() throws Exception {
        workNodeService.removeWorkNodeByHostname(NetUtils.getLocalAddress());
    }
