package co.mgentertainment.common.uidgen.config;
...
import co.mgentertainment.common.uidgen.worker.DisposableWorkNodeService;
...
@Configuration
@MapperScan(basePackages = "co.mgentertainment.common.uidgen.dal.mapper")
