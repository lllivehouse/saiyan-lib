package co.saiyan.common.fileupload.platform;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import co.saiyan.common.fileupload.*;
...
public class LocalPlusFileStorage implements FileStorage {
    ...
    public LocalPlusFileStorage(FileStorageProperties.LocalPlusConfig config) {
