package co.mgentertainment.common.mybatisplus.resolver;/*
 *
...
public class SqlFilterArgumentResolver implements HandlerMethodArgumentResolver {
	...
	private Predicate<String> sqlInjectPredicate() {
		return sql -> Arrays.stream(KEYWORDS).noneMatch(keyword -> org.apache.commons.lang3.StringUtils.containsIgnoreCase(sql, keyword));
	}
